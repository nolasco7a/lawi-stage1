      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-8 md:mb-12">
          ...
          <p className="text-lg md:text-xl text-muted-foreground max-w-3xl mx-auto">
            Desde visibilidad básica hasta herramientas de IA avanzadas. Encuentra el plan perfecto
            para tu práctica legal.
          </p>
        </div>
                  ...
                  {process.env.NODE_ENV === "development" && (
                    <div className="mt-4 p-3 bg-muted rounded-lg">
                      ...
                      <div className="text-xs text-muted-foreground space-y-1">
                        <div>
                          <strong>Product ID:</strong> {product.stripeProductId}
                        </div>
                        <div>
                          <strong>Price ID:</strong> {product.stripePriceId}
                        </div>
                      </div>
                    </div>
                  )}
        ...
        <div className="text-center mt-8 md:mt-12">
          <p className="text-muted-foreground mb-4">¿Necesitas ayuda para decidir?</p>
