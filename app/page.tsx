          ...
          <section className="pt-24 md:pt-32 pb-12 md:pb-16 px-4">
            <div className="max-w-6xl mx-auto text-center">
              ...
              <p className="text-lg sm:text-xl md:text-2xl text-muted-foreground mb-6 md:mb-8 max-w-3xl mx-auto px-2">
                Nuestro asistente legal con IA te orienta y conecta con abogados especializados en tu situación, sin complicaciones.
              </p>
            ...
            <div className="max-w-6xl mx-auto">
              <div className="text-center mb-8 md:mb-12">
                ...
                <p className="text-lg sm:text-xl text-muted-foreground max-w-3xl mx-auto px-2">
                  Únete a nuestra plataforma y conecta con clientes que ya buscan tus servicios especializados
                </p>
              </div>
                    ...
                    <div className="flex items-start space-x-3 md:space-x-4">
                      ...
                      <div className="flex-1 min-w-0">
                        <p className="text-sm md:text-base text-muted-foreground mb-3 md:mb-4">
                          "Me orientaron en minutos sobre mi problema laboral y encontré un abogado especializado confiable. El proceso fue súper sencillo."
                        </p>
                        <div>
                ...
                <Card>
                  <CardContent className="pt-4 md:pt-6">
                    <div className="flex items-start space-x-3 md:space-x-4">
                      ...
                      <div className="flex-1 min-w-0">
                        <p className="text-sm md:text-base text-muted-foreground mb-3 md:mb-4">
                          "Conseguí clientes calificados sin invertir en publicidad. La plataforma me conecta con personas que realmente necesitan mis servicios."
                        </p>
                        <div>
              ...
              <Accordion type="single" collapsible className="w-full">
                <AccordionItem value="item-1">
                  ...
                  <AccordionContent className="text-sm sm:text-base">
                    No, nuestro asistente de IA proporciona orientación inicial y te ayuda a entender tu situación legal, 
                    pero no sustituye el consejo legal profesional de un abogado. Su función es guiarte y conectarte 
                    con el abogado especializado adecuado para tu caso.
                  </AccordionContent>
                </AccordionItem>
                <AccordionItem value="item-2">
                  ...
                  <AccordionContent className="text-sm sm:text-base">
                    El uso del asistente de IA para orientación inicial es completamente gratuito para los usuarios. 
                    Solo los abogados pagan una suscripción para aparecer en la plataforma y recibir referencias de clientes.
                  </AccordionContent>
                </AccordionItem>
                <AccordionItem value="item-3">
                  ...
                  <AccordionContent className="text-sm sm:text-base">
                    Seleccionamos abogados basándonos en su especialidad, experiencia comprobada y suscripción activa. 
                    Todos los abogados en nuestra plataforma son verificados y deben mantener sus credenciales profesionales actualizadas.
                  </AccordionContent>
                </AccordionItem>
                <AccordionItem value="item-4">
                  ...
                  <AccordionContent className="text-sm sm:text-base">
                    Sí, absolutamente. Todas las consultas y conversaciones están protegidas por nuestras políticas de privacidad 
                    y cumplimos con los más altos estándares de confidencialidad. Tu información nunca se comparte sin tu consentimiento explícito.
                  </AccordionContent>
                </AccordionItem>
              </Accordion>
            </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 md:gap-8 mb-6 md:mb-8">
                ...
                <div>
                  ...
                  <div className="space-y-2">
                    <Link href="/chat" className="block text-sm md:text-base text-muted-foreground hover:text-foreground">
                      Asistente Legal
                    </Link>
                    <Link href="/register" className="block text-sm md:text-base text-muted-foreground hover:text-foreground">
                      Registro
                    </Link>
                    <Link href="/login" className="block text-sm md:text-base text-muted-foreground hover:text-foreground">
                      Iniciar Sesión
                    </Link>
                  </div>
                </div>
                <div>
                  ...
                  <div className="space-y-2">
                    <Link href="#" className="block text-sm md:text-base text-muted-foreground hover:text-foreground">
