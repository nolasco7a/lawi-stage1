...
export const createAccountSchema = (t: TranslateFunction) =>
  z.object({
...
export const createContactSchema = (t: TranslateFunction) =>
  z.object({
...
export const createPasswordSchema = (t: TranslateFunction) =>
  z
    .object({
      password: z
        .string()
